...
*/
        ...
        //redirect
        if($success == "true"){
           header('Location: /src/file-io/home.php?import=true&success=true'); die;
        }else{
           header('Location: /src/file-io/home.php?import=true&success=false'); die;
...
$(document).ready(function() {
    ...
    $('#contactsList').dataTable( {
        ...
        "bServerSide": true,
        "bJqueryUI":true,
        "sAjaxSource": "file-io/contacts_render.php"
    } );
        ...
        <form action='' method='post' name='form2' id='form2' enctype='multipart/form-data'>
            ...
            <fieldset class="wide" id="exportFields">
                ...
                <div>
                    ...
                    <br/> <br/>
                    <ul>
                        <table id="contactsList" class='gradeA' width="100%">
                                            <thead>
                                                <tr>
